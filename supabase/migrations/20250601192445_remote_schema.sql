...
CREATE TABLE IF NOT EXISTS "public"."vehicles_images" (
    "id" bigint NOT NULL,
    "vehicle_id" bigint,
...
ALTER TABLE "public"."vehicles_images" OWNER TO "postgres";


ALTER TABLE "public"."vehicles_images" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."vehicles_images_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
COMMENT ON TABLE "public"."waitlist" IS 'Waitlist emails';
...
ALTER TABLE ONLY "public"."vehicles_images"
    ADD CONSTRAINT "vehicles_images_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."vehicles_images"
    ADD CONSTRAINT "vehicles_images_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."profiles"("id") ON UPDATE CASCADE ON DELETE CASCADE;



ALTER TABLE ONLY "public"."vehicles_images"
    ADD CONSTRAINT "vehicles_images_vehicle_id_fkey" FOREIGN KEY ("vehicle_id") REFERENCES "public"."vehicles"("id") ON UPDATE CASCADE ON DELETE CASCADE;
...
GRANT ALL ON TABLE "public"."vehicles_images" TO "anon";
GRANT ALL ON TABLE "public"."vehicles_images" TO "authenticated";
GRANT ALL ON TABLE "public"."vehicles_images" TO "service_role";



GRANT ALL ON SEQUENCE "public"."vehicles_images_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."vehicles_images_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."vehicles_images_id_seq" TO "service_role";
